    ...
    <Fragment>
      ...
      <form className='form' onSubmit={(e) => onSubmit(e)}>
        ...
        <div className='form-group'>
          ...
          />
          <small className='form-text'>
            Please use comma separated values (eg. HZZO,GRAWE,CROATIA INSURANCE)
          </small>
        </div>
        <div className='form-group'>
          <input
        ...
        <small className='form-text'>
          Include international dialing code (eg. 021-333-333 )
        </small>
        <div className='form-group'>
          <input
            type='text'
          ...
          />
          <small className='form-text'>
            Put name and number of street of your working institution
          </small>
        </div>
        <div className='form-group'>
          <input
        ...
        <div className='form-group'>
          ...
          />
          <small className='form-text'>
            Please use comma separated values (eg. Pon 8 to 10, Uto 10-14)
          </small>
        </div>
        <div className='form-group'>
          <textarea
